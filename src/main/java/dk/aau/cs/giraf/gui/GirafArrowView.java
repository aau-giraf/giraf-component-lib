...
/**
 * Created by Marhlder on 27-03-2015.
*/
public class GirafArrowView extends View
{
    ...
    public GirafArrowView(Context context) {
        this(context, null, 0);
    }

    public GirafArrowView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public GirafArrowView(Context context, AttributeSet attrs, int defStyle) {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mMultiplier > 0) {
            String text = "Test"; //getContext().getString(R.string.multiplier_TEMPLATE, mMultiplier);
