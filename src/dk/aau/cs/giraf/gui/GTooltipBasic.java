...
public class GTooltipBasic {
    ...
    public GTooltipBasic(View anchorTo)
    {
        ...
        layout = LayoutInflater.from(context).inflate(R.layout.gtooltipbasic_layout, null);
    ...
    public void SetText(String text) {
        GTextView textView = (GTextView) layout.findViewById(R.id.GTooltip_Text);
        if (!hasImage)
        {
    ...
    {
        ImageView imgView = (ImageView) layout.findViewById(R.id.GTooltip_Image);
        GTextView textView = (GTextView) layout.findViewById(R.id.GTooltip_Text);
